...
public class BangChamCongUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbTrangThai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trạng thái", "Có đi làm", "Vắng có phép", "Vắng không phép" }));
    ...
    private void btLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLuuActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                ...
                chamCong.setMaChamCong("CC" + sttCC);
    ...
    private void btDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeleteActionPerformed
        ...
        BangChamCongBUS bus = new BangChamCongBUS();
        if (bus.delChamCong(dscc.get(i).getMaChamCong())) {
            dscc.remove(i);
    ...
    private void tblChamCongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChamCongMouseClicked
        int i = tblChamCong.getSelectedRow();
        txMaChamCong.setText(dscc.get(i).getMaChamCong());
